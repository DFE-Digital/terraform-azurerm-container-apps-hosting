...
| <a name="input_custom_private_endpoints"></a> [custom\_private\_endpoints](#input\_custom\_private\_endpoints) | A list of Private Endpoint objects | <pre>list(map(object({<br>    resource_group : object({<br>      id : string,<br>      name : string<br>    }),<br>    subnet_id : string,<br>    resource_id : string,<br>    subresource_names : optional(list(string), []),<br>    is_manual_connection : optional(bool, false)<br>  })))</pre> | `[]` | no |
