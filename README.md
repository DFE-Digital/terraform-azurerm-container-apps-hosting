...
module "azure_container_apps_hosting" {
  ...
  ## Deploy an Azure Database for PostgrSQL flexible server and create an initial database
...
| [azurerm_subnet.postgresql_private_endpoint_subnet](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/subnet) | resource |
